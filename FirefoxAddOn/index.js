...
function handleObtainCredentials() {
    ...
    browserAPI.tabs.create({ url: 'https://www.uparcel.sg/admin/login' });
}
...
function handleProceed() {
    ...
    browserAPI.storage.local.get(['setting_clearCredsAfterLogin', 'smartadmin_login', 'profileData'], async function(result){
        ...
        await browserAPI.tabs.create({ url: deepLinkUrl }, function(tab) {
...
function handleToggleSetting(settingName, isActive) {
    ...
    browserAPI.storage.local.set({ [settingKey]: isActive }, function() {
...
function checkCredentials() {
    browserAPI.storage.local.get(['smartadmin_login', 'profileData'], function(result) {
...
function updateCredentialsLocation() {
    ...
    browserAPI.storage.local.get('stagingLoggedIn', function(result){
...
function attachSettingsPageHandlers() {
    ...
    browserAPI.storage.local.get(settingKeys, function(result) {
